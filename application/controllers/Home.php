...
//                    'item_name' => $content['item_name'],
                    'item_name' => 'XeroSEO Extended Nulled by Weev',
...
//                $license_type = $content['license'];
    ...
    protected function addon_credential_check($purchase_code="",$item_name="")
    {
        ...
        $url = "http://xeroneit.net/development/envato_license_activation/purchase_code_check.php?purchase_code={$purchase_code}&domain=nope&item_name=XeroSeo-{$item_name}";
