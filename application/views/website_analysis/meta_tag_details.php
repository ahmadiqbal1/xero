<?php
	...
	$meta_tag_information = json_decode($meta_tag_info[0]['meta_tag_information'],true);
	...
	$one_phrase = json_decode($meta_tag_info[0]['one_phrase'],true);
	$two_phrase = json_decode($meta_tag_info[0]['two_phrase'],true);
	$three_phrase = json_decode($meta_tag_info[0]['three_phrase'],true);
	$four_phrase = json_decode($meta_tag_info[0]['four_phrase'],true);
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									...
									<div class="card-header-action">
										<a id="accordionExample1" data-toggle="collapse" data-target="#singleword-collapse" aria-expanded="true" aria-controls="singleword-collapse" href="#"><i class="fas fa-minus"></i></a>
									</div>
								</div>
								
								<div id="singleword-collapse" class="collapse show" aria-labelledby="singleword" data-parent="#accordionExample1">
									<div class="card-body">
										<div class="table-responsive" <?php if(is_array($one_phrase) && count($one_phrase) > 0) echo 'style="height: 300px;"'?>>
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									...
									<div class="card-header-action">
										<a id="accordionExample2" data-toggle="collapse" data-target="#doubleword-collapse" aria-expanded="true" aria-controls="doubleword-collapse" href="#"><i class="fas fa-minus"></i></a>
									</div>
								</div>
								
								<div id="doubleword-collapse" class="collapse show" aria-labelledby="doubleword" data-parent="#accordionExample2">
									<div class="card-body">
										<div class="table-responsive" <?php if(is_array($two_phrase) && count($two_phrase) > 0) echo 'style="height: 300px;"'?>>
											<table class="table table-hover table-striped table-bordered text-center">
												<thead class="thead-light thead-primary">
													<tr>
						...
						<div class="col-12">
							<div class="card card-primary">
								...
								<div id="tripleeword-collapse" class="collapse show" aria-labelledby="tripleeword" data-parent="#accordionExample3">
									<div class="card-body">
										<div class="table-responsive" <?php if(is_array($three_phrase) && count($three_phrase) > 0) echo 'style="height: 300px;"'?>>
											<table class="table table-hover table-striped table-bordered text-center">
												<thead class="thead-light thead-primary">
													<tr>
						...
						<div class="col-12">
							<div class="card card-primary">
								...
								<div id="fourword-collapse" class="collapse show" aria-labelledby="fourword" data-parent="#accordionExample4">
									<div class="card-body">
										<div class="table-responsive" <?php if(is_array($four_phrase) && count($four_phrase) > 0) echo 'style="height: 300px;"'?>>
											<table class="table table-hover table-striped table-bordered text-center">
												<thead class="thead-light thead-primary">
													<tr>
